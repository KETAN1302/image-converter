      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-4 text-center">
            ...
            <h3 className="font-medium text-gray-900 dark:text-white mb-1">Batch Processing</h3>
            <p className="text-sm text-gray-500 dark:text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-gray-50 dark:bg-gray-900 rounded-2xl p-6">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-500 dark:text-white">Image Formats</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900 dark:text-white">PDF</div>
            <div className="text-xs text-gray-500 dark:text-white">Document Support</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900 dark:text-white">∞</div>
            <div className="text-xs text-gray-500 dark:text-white">No Limits</div>
          </div>
          <div className="text-center">

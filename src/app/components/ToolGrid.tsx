  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Crop Image */}
        <Link href="/crop" className="group">
          <div className="p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-red-500 hover:shadow-lg transition-all">
            <div className="w-12 h-12 bg-red-100 dark:bg-gray-800 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            <p className="text-sm text-gray-500 dark:text-white mb-4">
              Crop and cut out specific areas from your images
            </p>
            <span className="text-sm text-red-600 font-medium group-hover:gap-2 inline-flex items-center gap-1">
              Try now <ArrowRightIcon className="w-3 h-3" />
            </span>
          </div>
        </Link>
        ...
        {/* Rotate Image */}
        <Link href="/rotate" className="group">
          <div className="p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-orange-500 hover:shadow-lg transition-all">
            <div className="w-12 h-12 bg-orange-100 dark:bg-gray-800 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <ArrowUturnRightIcon className="w-6 h-6 text-orange-600" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
              Rotate Image
            </h3>
            <p className="text-sm text-gray-500 dark:text-white mb-4">
              Rotate images by any angle with ease
            </p>
            <span className="text-sm text-orange-600 font-medium group-hover:gap-2 inline-flex items-center gap-1">
              Try now <ArrowRightIcon className="w-3 h-3" />
            </span>
          </div>
        </Link>
        ...
        <Link href="/resize" className="group">
          <div className="p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-yellow-500 hover:shadow-lg transition-all">
            <div className="w-12 h-12 bg-yellow-100 dark:bg-gray-800 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <AdjustmentsHorizontalIcon className="w-6 h-6 text-yellow-600" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
              Resize Image
            </h3>

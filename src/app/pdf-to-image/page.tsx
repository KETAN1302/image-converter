  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="sticky top-0 z-10 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 px-4 py-3">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">
            Convert your PDF document pages into high-quality images locally in
            your browser
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 md:py-8">
        ...
        {!pdfFile && (
          <div className="mb-6">
            <div
              ...
              className={`relative w-full p-8 border-3 border-dashed rounded-2xl transition-all duration-300 cursor-pointer ${
                isDragging
        ...
        {/* PDF File Info & Configuration Options */}
        {pdfFile && pdfInfo && (
          <div className="mb-6 p-4 md:p-6 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800">
            ...
            {/* File details card */}
            <div className="mb-6 flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-800">
              <div className="w-12 h-12 rounded-lg bg-red-100 dark:bg-red-900/30 flex items-center justify-center shrink-0">
                <DocumentIcon className="w-7 h-7 text-red-600 dark:text-red-400" />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-850 text-gray-900 dark:text-white rounded-xl p-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                >
                    ...
                    <button
                      ...
                      className={`p-2.5 rounded-xl border text-center transition-all ${
                        scale === opt.val
                          ...
                          : "border-gray-250 dark:border-gray-750 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800"
                      }`}
                    >
            ...
            {!isConverting && convertedImages.length === 0 && (
              <button
                ...
                className="w-full py-3.5 bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold rounded-xl transition-all shadow-md active:scale-99 flex items-center justify-center gap-2"
              >
            ...
            {isConverting && (
              <div className="mt-4">
                <div className="flex justify-between items-center text-xs text-gray-600 dark:text-gray-400 mb-1.5 font-medium">
                  <span>
          ...
          <div className="mt-8 animate-in fade-in duration-300">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 pb-4 border-b border-gray-100 dark:border-gray-800">
              ...
              <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                ...
                <button
                  onClick={clearAll}
                  className="flex-1 sm:flex-none px-5 py-2.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-250 dark:hover:bg-gray-700 text-gray-700 dark:text-white rounded-xl text-sm font-semibold transition-colors"
                >
                  Convert Another
                </button>
              </div>
              ...
              {convertedImages.map((img) => (
                ...
                >
                  ...
                  <div className="aspect-[3/4] bg-gray-50 dark:bg-gray-800 relative w-full overflow-hidden flex items-center justify-center p-2">
                    ...
                    >
                      <div className="bg-white text-gray-800 rounded-full p-3 shadow-lg transform scale-90 group-hover:scale-100 transition-transform duration-200">
